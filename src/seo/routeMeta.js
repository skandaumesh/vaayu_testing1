...
// Consumed at runtime by src/components/SeoManager.jsx and at build time by
// scripts/gen-seo-pages.mjs, which prerenders a static HTML shell per route.
// Keep route keys lowercase and without a trailing slash.

export const BASE = "https://vaayuchest.com";
export const BRAND = "Vaayu Chest & Sleep Specialists, Bengaluru";

// Pages that own their <head> (dedicated Helmet blocks or bespoke prerenders).
export const SKIP = ["/revive-2026", "/rehab-conference", "/capi-2025", "/voric"];

// Routes with a bespoke prerender in scripts/gen-seo-pages.mjs; the generic
// shell generator must not overwrite these.
export const CUSTOM_PRERENDER = ["/revive-2026", "/voric"];
